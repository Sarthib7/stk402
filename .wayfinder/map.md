...
- Host always-on Consumer page + Paid Resource on **Render** — **deploy on hold** until user says go ([ticket](tickets/host-on-render.md)); tunnel OK meanwhile
...
- [Host on Render (deploy on hold)](tickets/host-on-render.md) — Render locked; wait for user go-ahead before deploy.
...
3. ~~Hosting pick~~ — **resolved 2026-08-15: Render**; deploy on hold until user unblocks.
